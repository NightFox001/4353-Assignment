  ...
  return (
    <div className="relative bg-white mt-6 rounded-xl p-6 shadow-xl">
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="mr-4 flex flex-col items-center">
            <div style={{ fontWeight: 700, fontSize: 12, marginBottom: 5 }}>Order Date</div>
            <div>{quote.date_requested}</div>
        </div>
        <div className="mr-4 flex flex-col items-center">
          <div style={{ fontWeight: 700, fontSize: 12, marginBottom: 5 }}>Delivered</div>
          <div>{quote.date_delivered}</div>
        </div>
        <div className="mr-4 flex flex-col items-center">
          <div style={{ fontWeight: 700, fontSize: 12, marginBottom: 5 }}>Gallons</div>
